...
static const _TargetBlock_type_support_symbol_names_t _TargetBlock_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, package_with_interfaces, msg, TargetBlock)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, package_with_interfaces, msg, TargetBlock)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, package_with_interfaces, msg, TargetBlock)() {
  return &::package_with_interfaces::msg::rosidl_typesupport_c::TargetBlock_message_type_support_handle;
}
