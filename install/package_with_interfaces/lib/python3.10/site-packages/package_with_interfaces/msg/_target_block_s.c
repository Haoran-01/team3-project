...
bool package_with_interfaces__msg__target_block__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("package_with_interfaces.msg._target_block.TargetBlock", full_classname_dest, 53) == 0);
  }
  package_with_interfaces__msg__TargetBlock * ros_message = _ros_message;
  {  // position
...
{
  /* NOTE(esteve): Call constructor of TargetBlock */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("package_with_interfaces.msg._target_block");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TargetBlock");
